...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { person_id: @trainer.person_id, training_id: @trainer.training_id } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { person_id: @trainer.person_id, training_id: @trainer.training_id } }
