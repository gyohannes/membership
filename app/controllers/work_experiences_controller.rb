class WorkExperiencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @work_experience.save
        format.html { redirect_to @work_experience.person.member, notice: 'Work experience was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @work_experience.update(work_experience_params)
        format.html { redirect_to @work_experience.person.member, notice: 'Work experience was successfully updated.' }
  ...
  def destroy
    person = @work_experience.person
    @work_experience.destroy
    respond_to do |format|
      format.html { redirect_to person, notice: 'Work experience was successfully destroyed.' }
  ...
  private
    ...
    def work_experience_params
      params.require(:work_experience).permit(:person_id, :company, :job_title, :from, :to, :description)
    end
end
