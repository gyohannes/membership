class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:user_id, :title, :start_date, :end_date, :maximum_participants, :event_details,
       :status, :location, :contact_person, :contact_phone, :contact_email)
    end
end
