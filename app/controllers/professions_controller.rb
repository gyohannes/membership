class ProfessionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @profession.save
        format.html { redirect_to professions_path, notice: 'Profession was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @profession.update(profession_params)
        format.html { redirect_to professions_path, notice: 'Profession was successfully updated.' }
  ...
  private
    ...
    def profession_params
      params.require(:profession).permit(:profession_category_id, :name)
    end
end
